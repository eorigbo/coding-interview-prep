...
public class MergeSortedArraysTest {
    ...
    public void mergeArraysSizeTest(){
        ...
        int[] mergedArray = MergeSortedArrays_Attempt.mergeArrays(firstArray, secondArray);
    ...
    public void bothArraysAreEmptyTest() {
        ...
        final int[] expected = {};
        final int[] actual = MergeSortedArrays_Attempt.mergeArrays(myArray, alicesArray);
