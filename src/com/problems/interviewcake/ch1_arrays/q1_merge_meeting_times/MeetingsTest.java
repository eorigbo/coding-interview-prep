package com.problems.interviewcake.ch1_arrays.q1_merge_meeting_times;
...
public class MeetingsTest {
    ...
    public void mergeMeetingTest(){
        ...
        List<Meeting> mergedMeetings = Meetings_Attempt.mergeMeetings(rawMeetings);
    ...
    public void meetingsOverlapTest() {
        ...
        final List<Meeting> actual = Meetings_Attempt.mergeMeetings(meetings);
