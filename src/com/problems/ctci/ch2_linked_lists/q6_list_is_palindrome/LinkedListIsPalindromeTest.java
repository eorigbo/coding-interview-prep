...
import static com.problems.ctci.ch2_linked_lists.q6_list_is_palindrome.LinkedListIsPalindromeAttempt.isPalindrome;
...
public class LinkedListIsPalindromeTest {
    ...
    public void smallListTest(){
        ...
        boolean actualResult = isPalindrome(nodeList[0]);
